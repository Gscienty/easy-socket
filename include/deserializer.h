...
namespace eys {
    ...
    struct value_type_deserializer {
        static T deserialize(const char *v, const size_t len, size_t &seek) {
            T ret;
    ...
    struct deserializer<unsigned char> {
        static unsigned char deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<short> {
        static short deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<unsigned short> {
        static unsigned short deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<int> {
        static int deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<unsigned int> {
        static unsigned int deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<long> {
        static long deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<unsigned long> {
        static unsigned long deserialize(const char *buffer, size_t len, size_t &seek) {
    ...
    struct deserializer<std::string> {
        static std::string deserialize(const char *buffer, size_t len, size_t &seek) {
